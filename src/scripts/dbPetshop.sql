...
ALTER TABLE TB_PETS ADD COLUMN NOME VARCHAR(50) NOT NULL;
...
INSERT INTO TB_PERFIS (DESCRICAO) VALUES ('Tutor'); -- retornará ID 2
INSERT INTO TB_PERFIS (DESCRICAO) VALUES ('Funcionario'); -- retornará ID 3
