                ...
                btnMudarStatus.addActionListener(e -> {
                    ...
                    if (confirma == JOptionPane.YES_OPTION) {
                        ...
                        if (usuario.getAtivo().equalsIgnoreCase("S")) {
                            ...
                            // Assumindo que você criará este método, similar ao 'inativarUsuario'
                            // sucesso = usuarioDAO.ativarUsuario(usuario.getEmail()); 
                            sucesso = false; // Placeholder
                        ...
                        if (sucesso) {
                            ...
                            frameAtual.dispose();
                            new GerenciarUsuario(); // para atualizar a listagem
                        } else if (!acao.equals("reativar")) { // Evita mostrar erro se a função não existe
